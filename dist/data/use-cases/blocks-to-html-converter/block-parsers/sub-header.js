...
exports.SubHeaderBlockParser = void 0;
var block_to_inner_html_1 = require("../../../helpers/block-to-inner-html");
var format_to_style_1 = require("../../format-to-style");
var SubHeaderBlockParser = /** @class */ (function () {
    function SubHeaderBlockParser(block) {
        this._block = block;
    }
    SubHeaderBlockParser.prototype.convert = function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = (_c = "<h2".concat(style, ">")).concat;
                        return [4 /*yield*/, (0, block_to_inner_html_1.blockToInnerHtml)(this._block)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_d.apply(_c, [_e.sent(), "</h2>"])])];
                }
            });
        });
    };
    return SubHeaderBlockParser;
}());
exports.SubHeaderBlockParser = SubHeaderBlockParser;
