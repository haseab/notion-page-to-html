            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _d = (_c = "<blockquote".concat(style, ">")).concat;
                        return [4 /*yield*/, (0, block_to_inner_html_1.blockToInnerHtml)(this._block)];
                    case 1: return [2 /*return*/, _b.apply(_a, [_d.apply(_c, [_e.sent(), "</blockquote>"])])];
                }
            });
        });
    };
    return QuoteBlockToHtml;
}());
exports.QuoteBlockToHtml = QuoteBlockToHtml;
